...
const typeToMsg = {
  ...
  data_listcontainsitem: `${listPlaceholder} contains ${holePlaceholder(1)}?`,
  data_lengthoflist: `length of ${listPlaceholder}`,
  data_itemoflist: `item ${holePlaceholder(1)} of ${listPlaceholder}`,
  data_itemnumoflist: `item # of ${holePlaceholder(1)} of ${listPlaceholder}`,
